...
>   "remaining" : 0
> }
> > [user_elastic@1d3fec67dbba /]$ curl -ku elastic:B1HWSqWdFz2IEpKnOAVz -X POST "https://localhost:9200/_snapshot/netology_backup/my_snapshot_2022.04.24/_restore?pretty" -H 'Content-Type: application/json' -d'
> {
>   "indices": "test"
> }
> '
